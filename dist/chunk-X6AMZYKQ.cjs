...
async function loginCSRAccount(request, actionContext, account, impersonatedCustomerEmail, config) {
  ...
  const accountApi = new AccountApi(actionContext.frontasticContext, _chunkTLTXMAELcjs.getLocale.call(void 0, request), _chunkTLTXMAELcjs.getCurrency.call(void 0, request), request);

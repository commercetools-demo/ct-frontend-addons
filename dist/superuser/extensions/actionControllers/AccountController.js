...
export var loginHookWithCSRCheck = function (originalCb, config) {
    return function (request, actionContext) { return __awaiter(void 0, void 0, void 0, function () {
        var originalResult, account, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, originalCb(request, actionContext)];
                case 1:
                    originalResult = _a.sent();
                    if (originalResult.statusCode === 200 && (originalResult === null || originalResult === void 0 ? void 0 : originalResult.body)) {
                        account = JSON.parse(originalResult.body);
                        if (account.customerGroupId && account.customerGroupId === (config === null || config === void 0 ? void 0 : config.props.csrCustomerGroupId)) {
                            response = {
                                statusCode: 300,

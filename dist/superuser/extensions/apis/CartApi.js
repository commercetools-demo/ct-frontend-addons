    ...
    return /** @class */ (function (_super) {
        ...
        function CartApi() {
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.requestBuilder()
                                    ...
                                    return response.body.results.map(function (order) { return CartMapper.commercetoolsOrderToOrder(order, locale); });
                                })
                                    .catch(function (error) {
                                    throw new ExternalError({ status: error.code, message: error.message, body: error.body });
                                })];
            ...
            _this.setSuperUserEmailOnOrder = function (order, superUserEmail, customType, customField) { return __awaiter(_this, void 0, void 0, function () {
                var locale, orderObj, fields, orderUpdate;
                var _a;
                var _b, _c, _d, _e;
                return __generator(this, function (_f) {
                    switch (_f.label) {
                        ...
                        case 1:
                            locale = _f.sent();
                            return [4 /*yield*/, this.getOrderByID(order.cartId)];
                        case 2:
                            orderObj = _f.sent();
                            fields = {};
                            ...
                            return [4 /*yield*/, this.requestBuilder()
                                    ...
                                    .execute()
                                    .then(function (response) { return CartMapper.commercetoolsOrderToOrder(response.body, locale); })
                                    .catch(function (error) {
                                    throw new ExternalError({ status: error.code, message: error.message, body: error.body });
                                })];
                        case 3:

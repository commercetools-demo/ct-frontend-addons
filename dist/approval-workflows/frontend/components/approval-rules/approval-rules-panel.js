...
var ApprovalFlowsClientWrapper = function (_a) {
    var _b, _c, _d;
    var businessUnitKey = _a.businessUnitKey, storeKey = _a.storeKey, sdk = _a.sdk, components = _a.components, permissions = _a.permissions, translate = _a.translate;
    var getApprovalRules = useApprovals(sdk, businessUnitKey, storeKey).getApprovalRules;
    ...
    var _f = useState([]), rules = _f[0], setRules = _f[1];
    ...
    var previousCursor = rules.previousCursor;
    var nextCursor = rules.nextCursor;
    var total = (_b = rules.total) !== null && _b !== void 0 ? _b : 0;
    useEffect(function () {
        if (businessUnitKey) {
            (function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, getApprovalRules(__assign(__assign(__assign({ limit: limit, cursor: cursor }, (states.length ? { states: states } : {})), (debouncedSearch ? { predicate: debouncedSearch.trim() } : {})), { createdFrom: ISODate.from, createdTo: ISODate.to }))];
                        case 1:
                            results = _a.sent();
                            setRules(results);
                            return [2 /*return*/];

...
var Refinements = function (_a) {
    var _b;
    var filters = _a.filters, onSearch = _a.onSearch, statusOptions = _a.statusOptions, onStatusRefine = _a.onStatusRefine, onCreationDateRefine = _a.onCreationDateRefine, translate = _a.translate, components = _a.components, children = _a.children;
    var refinements = [
        {
            title: 'dashboard.rules.search.label',
            Component: (React.createElement(components.SearchInput, { className: "h-[38px] w-[360px]", searchValue: (_b = filters === null || filters === void 0 ? void 0 : filters.search) !== null && _b !== void 0 ? _b : '', variant: "xs", placeholder: "".concat(translate === null || translate === void 0 ? void 0 : translate('dashboard.search.for.rules'), "..."), handleOnChange: function (val) { return onSearch === null || onSearch === void 0 ? void 0 : onSearch(val); } })),
        },
        {
            title: 'common.status',
            ...
            Component: (React.createElement(components.Dropdown, { size: "lg", className: "w-[200px]" },
                ...
                React.createElement(components.Dropdown.Options, { className: "max-h-[unset] w-max" },
                    React.createElement(components.DatePicker, { mode: "range", selected: {
                            ...
                            return onCreationDateRefine === null || onCreationDateRefine === void 0 ? void 0 : onCreationDateRefine({ from: range === null || range === void 0 ? void 0 : range.from, to: range === null || range === void 0 ? void 0 : range.to });
                        } })))),
        },
    ];
    return (React.createElement("div", { className: "hidden items-end justify-between lg:flex" },
        React.createElement("div", { className: "hidden gap-3 lg:flex" }, refinements.map(function (_a, index) {

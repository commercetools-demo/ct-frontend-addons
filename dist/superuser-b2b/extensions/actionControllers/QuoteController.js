...
export var createQuoteRequest = function (originalCb, config) {
    return function (request, actionContext) { return __awaiter(void 0, void 0, void 0, function () {
        var CartApi, cartApi, cartId, originalCart, originalOwnerEmail, originalResult;
        var _a, _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, cartApi.setOriginalCustomerDataOnCart(cartId, originalCart.version, originalOwnerEmail)];
                case 2:
                    _d.sent();
